...
import com.malex.model.Person;
import com.malex.util.DateUtil;
...
public class PersonOverviewController {
    ...
    /**
     * Call the main application that save the link on object.
     *
    ...
    private void showPersonDetails(Person person) {
        if (person != null) {
            ...
            birthdayLabel.setText(DateUtil.format(person.getBirthday()));  // TODO: Нам нужен способ для перевода дня рождения в тип String!
        } else {
